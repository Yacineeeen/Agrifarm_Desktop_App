...
public class UserService implements IService<User> {
    ...
    public void add(User user) throws SQLException {
        // Stockage du mot de passe en texte clair
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            pstmt.setString(4, user.getPassword()); // Mot de passe stocké en texte clair
    ...
    public void update(User user) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
            ...
            int paramIndex = 4;
            if (updatePassword) {
                pstmt.setString(paramIndex++, user.getPassword()); // Mot de passe en texte clair
            }
    ...
    private User mapResultSetToUser(ResultSet rs) throws SQLException {
        ...
        user.setPassword(rs.getString("password")); // Récupération du mot de passe en clair
    ...
    public boolean resetPassword(String token, String newPassword) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
            pstmt.setString(1, newPassword); // Mot de passe en texte clair
