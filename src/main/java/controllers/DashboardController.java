...
public class DashboardController implements Initializable {
    ...
    private Button createEntityButton(String name) {
        ...
        button.setOnAction(event -> {
            ...
            // Update paths to match your package structure
            String fxmlFile;
            switch (name) {
                case "User":
                    fxmlFile = "/AfficherUser.fxml";  // Utiliser ce chemin pour User
                    break;
                case "Machine":
                    fxmlFile = "/esprit/tn/demo/viewMachine.fxml";
                    break;
                case "Technicien":
                    fxmlFile = "/esprit/tn/demo/technicien-view.fxml";
                    break;
                case "Maintenance":
                    fxmlFile = "/esprit/tn/demo/ViewMaintenance.fxml";
                    break;
                case "Animal":
                    fxmlFile = "/AnimalReadView.fxml";
                    break;
                case "Etat":
                    fxmlFile = "/SuiviReadView.fxml";
                    break;
                case "Vétérinaire":
                    fxmlFile = "/VeterinaireReadView.fxml";
                    break;
                case "Produit":
                    fxmlFile = "/AfficherProduit.fxml";
                    break;
                case "Quantité":
                    fxmlFile = "/AfficherCommande.fxml";
                    break;
                // Étude section
                case "Culture":
                    fxmlFile = "/AfficherCulture.fxml";
                    break;
                case "Etude":
                    fxmlFile = "/AfficherEtude.fxml";
                    break;
                case "Expert":
                    fxmlFile = "/AfficherExpert.fxml";
                    break;
                // Abonnement section
                case "Facture":
                    fxmlFile = "/AfficherFacture.fxml";  // Assuming you have this
                    break;
                case "Abonnement":
                    fxmlFile = "/AfficherAbonnement.fxml";
                    break;
                default:
                    fxmlFile = "/AfficherUser.fxml";  // Changé de "/esprit/tn/demo/Afficher" + name + ".fxml"
            }
