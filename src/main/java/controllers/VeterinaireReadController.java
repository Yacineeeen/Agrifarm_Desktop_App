...
public class VeterinaireReadController {
    ...
    private void handleAddVeterinaire() {
        try {
            URL location = getClass().getResource("/VeterinaireAddView.fxml");
            if (location == null) {
    ...
    private void openUpdateVeterinaireForm(Veterinaire veterinaire) {
        try {
            URL location = getClass().getResource("/VeterinaireUpdateView.fxml");
            if (location == null) {
    ...
    private void openDeleteVeterinaireForm(Veterinaire veterinaire) {
        try {
            URL location = getClass().getResource("/VeterinaireDeleteView.fxml");
            if (location == null) {
